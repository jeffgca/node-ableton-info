...
let exePath = 'C:\\Windows\\System32\\notepad.exe'
...
execFile(
	...
	[
		...
		'-Command',
		// 'Get-Date; $PSVersionTable.PSVersion',
		`(Get-Item '${liveExePath}').VersionInfo.ProductVersion`,
	],
	{ windowsHide: true },
	(err, stdout, stderr) => {
		if (err) {
...
// const command = `powershell.exe`,-command "(Get-Item '${filePath}').VersionInfo.ProductVersion"`
...
// 		return
// 	}
// 	console.log(`Product Version: ${stdout.trim()}`)
// })
